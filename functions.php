...
function business_setup() {
	...
	register_nav_menus( array(
		'Footer-menu' => esc_html__( 'Footer menu', 'business' ),
	) );
    /*
    ...
    $args = array(
        ...
        'flex-width'    => true,
        'flex-height'   => true,
        'default-image' => get_template_directory_uri() . '/img/home/header/logo.png',
        'uploads'       => true,
    );
...
function header_phone_number() {
	register_sidebar( array(
		'name'          => esc_html__( 'Header phone', 'business' ),
		'id'            => 'phone',
		'description'   => esc_html__( 'Widget home number', 'business' ),
		'before_widget' => '',
		'after_widget'  => '',
		'before_title'  => '<a href="tel:+9978 8856 999">',
		'after_title'   => '</a>',
	) );
}
add_action( 'widgets_init', 'header_phone_number' );
...
function business_scripts() {
    ...
    wp_enqueue_style( 'bootstrap', get_stylesheet_directory_uri().'/bower_components/bootstrap/dist/css/bootstrap-flex.min.css');
	...
	wp_enqueue_script( 'jquery', get_template_directory_uri() . '/bower_components/jquery/dist/jquery.min.js', array(''), '20151215', true );
	wp_enqueue_script( 'tether', get_template_directory_uri() . '/bower_components/tether/dist/js/tether.min.js', array(), '20151215', true );
	wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/bower_components/bootstrap/dist/js/bootstrap.min.js', array(), '20151215', true );
